...
struct pkvm_mm_ops iommu_pw_coherency_mm_ops = {
...
struct pkvm_mm_ops iommu_pw_noncoherency_mm_ops = {
	.phys_to_virt = pkvm_phys_to_virt,
	.virt_to_phys = pkvm_virt_to_phys,
	.zalloc_page = iommu_zalloc_page,
	.get_page = iommu_get_page,
...
static inline int __sync_shadow_id(struct pkvm_iommu *iommu, unsigned long vaddr,
