 ...
 * the returned SAGAW.
 */
static inline unsigned long __iommu_calculate_sagaw(struct intel_iommu *iommu)
{
...
static inline int __iommu_calculate_agaw(struct intel_iommu *iommu, int max_gaw)
{
	unsigned long sagaw;
	int agaw;
